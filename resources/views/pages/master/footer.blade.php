        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-4">
                <div class="bg-primary rounded p-4">
                    <a href="index.html"><h1 class="text-white text-uppercase mb-3">Black Horse Hotel</h1></a>
                    <p class="text-white mb-0">
                     <a class="text-dark fw-medium" href="index">Black Horse Hotel</a>, every stay is a story. And it starts with love. We believe luxury – meaningful, personalized, warm – is our love language, and we deliver it one small act at a time.
                     .
                    </p>
                </div>
            </div>
