                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('userprofile.update', $user->id) }}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn  px-4" style="background: #4D4D8D;color:azure" value="Save Changes">
                                    </div>
                                </div>
                                <br><br>
                                <hr class="my-4">
                                            ...
                                            @foreach ($reservation as $row)
                                                <tr>
                                                    ...
                                                    <form class="float-end" method="post"
                                                        ...
                                                        <td> <input type="button" class="btn  btn-sm" style="background: #4D4D8D;color:azure"
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit"
                                                                            class="btn"style="background: #4D4D8D;color:azure">Add Review</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center"> <br> <br>
                                <img src="/img/testimonial-1.jpg" alt="Admin" class="rounded-circle p-1 "
                                    width="110">
                                <div class="mt-3">
                                    <br>
                                    <h4>{{ $user->name }}</h4>
