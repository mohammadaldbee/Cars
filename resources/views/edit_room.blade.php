...
<div class="card">
	...
	<div class="card-body">
		<form method="post" action="{{ route('roomsAdmin.update',$rooms->id) }}" enctype="multipart/form-data">
			@csrf
			@method('PATCH')
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="text" name="num_of_beds" class="form-control" value="{{$rooms->num_of_beds}}" />
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="text" name="room_price"  class="form-control" value="{{$rooms->price}}" >
				</div>
			</div>
			...
			<div class="row mb-4">
				...
				<div class="col-sm-10">
					<textarea type="text" name="room_description" class="form-control" rows="3" >{{$rooms->description}}</textarea>
				</div>
			</div>
