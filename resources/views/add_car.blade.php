...
@section('content')
    ...
    <div class="container col-6 mt-2">
        ...
        <div class="card">
            <div class="card-header">Add a car
                <a href="{{ route('admin.carAdmin.index') }}" class="btn btn-secondary btn-sm float-end"> Go Back</a>
            </div>

            <div class="card-body">
                <form method="post" action="{{ route('admin.carAdmin.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea type="text" name="car_description" rows="6" class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="row mb-4">
                            ...
                            <div class="row mb-4">
                                <label class="col-sm-2 col-label-form">Image1</label>
                                <div class="col-sm-10">
                                    <input type="file" name="car_image1" />
                                </div>
                            </div>
                            <div class="row mb-4">
                                <label class="col-sm-2 col-label-form">Image2</label>
                                <div class="col-sm-10">
